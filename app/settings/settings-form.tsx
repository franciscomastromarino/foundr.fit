    ...
    <Container maxW="sm" py="10">
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack gap="5">
          ...
          <Field.Root>
            <Field.Label>Bio ({bioLength}/280)</Field.Label>
            <Textarea {...register('bio')} maxLength={280} rows={3} />
          </Field.Root>

          <Field.Root>
            <Field.Label>Ciudad</Field.Label>
            <Input {...register('city')} maxLength={80} />
          </Field.Root>

          <Field.Root invalid={!!errors.linkedinUrl}>
            <Field.Label>LinkedIn URL</Field.Label>
            <Input {...register('linkedinUrl')} placeholder="https://linkedin.com/in/..." type="url" />
            {errors.linkedinUrl && <Field.ErrorText>{errors.linkedinUrl.message}</Field.ErrorText>}
          </Field.Root>

          <Field.Root>
            <HStack justify="space-between">
              <Field.Label mb="0">Visible para otros miembros</Field.Label>
              <Controller
                name="visible"
                control={control}
                render={({ field }) => (
          ...
          {!showDelete ? (
            ...
            <Stack gap="2" p="4" borderWidth="1px" borderColor="red.300" borderRadius="lg">
